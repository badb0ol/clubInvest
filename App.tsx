...
export default function App() {
    ...
    const [showIosBanner, setShowIosBanner] = useState(() => {
        ...
        const dismissed = localStorage.getItem('ios-pwa-banner-dismissed') === 'true';
            ...
            <div className="min-h-screen bg-[#0a0a0a] flex flex-col relative overflow-hidden">
                ...
                {showIosBanner && (
                    <div className="fixed bottom-0 left-0 right-0 z-[200] p-4">
                        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 shadow-2xl flex items-start gap-3 max-w-sm mx-auto">
                            <div className="w-10 h-10 bg-white rounded-xl flex-shrink-0 flex items-center justify-center">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" style={{ stroke: '#0a0a0a' }} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M3 21H21"/><path d="M3 16L9 10L13 14L21 6"/><path d="M21 6V10M21 6H17"/>
                                </svg>
                            </div>
                            <div className="flex-1 min-w-0">
                                <p className="text-white text-sm font-semibold mb-0.5">Installer ClubInvest</p>
                                <p className="text-zinc-400 text-xs leading-relaxed">
                                    Appuyez sur <span className="inline-flex items-center gap-0.5 text-zinc-300 font-medium">
                                    ...
                                    </span> puis <strong className="text-zinc-200">« Ajouter à l'écran d'accueil »</strong>
                                </p>
                            </div>
                            <button
                                onClick={() => { localStorage.setItem('ios-pwa-banner-dismissed', 'true'); setShowIosBanner(false); }}
    ...
    return (
        <div className="font-sans transition-colors duration-500 min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-zinc-100 md:flex">
            ...
            {showIosBanner && (
                <div className="fixed bottom-0 left-0 right-0 z-[200] p-4 safe-area-bottom">
                    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 shadow-2xl flex items-start gap-3 max-w-sm mx-auto">
                        <div className="w-10 h-10 bg-white rounded-xl flex-shrink-0 flex items-center justify-center">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" style={{ stroke: '#0a0a0a' }} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                <path d="M3 21H21"/><path d="M3 16L9 10L13 14L21 6"/><path d="M21 6V10M21 6H17"/>
